...
<html lang="en">
<head>
    <title>Profile | Kingdom Life Church</title>
                    ...
                    <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                        ...
                        if (isset($_SESSION['user_session'])){
                            ...
                            echo '
                                ...
                                <li class="dropdown profile current-menu-item">
                                <a class="navbarDropdown nav-link dropdown-toggle" role="button" id="dropdownMenuLink3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink3">
                                        ...
                                        <a class="dropdown-item" href="profile?mystory=true">My Story</a>
                                        <a class="dropdown-item" href="profile?offerings=true">My Offerings</a>
                                        <a class="dropdown-item" href="profile?orders=true">My Orders</a>
                                        <a class="dropdown-item" href="profile?accountsetting=true">Account Settings</a>
            ...
            <div class="modal-body">
                ...
                <form style="border-radius: 20px;" class="contact-form text-center m-0" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input style="width: auto;" name="username" type="text" class="form-control m-0 p-4 <?php echo $invalid_username;?>" value="<?php echo $_GET['username'];?>" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                        <?php echo $invalid_username_Msg;?>
                    </div>
                    <input name="email" type="text" id="defaultRegisterFormEmail" class="form-control m-0 p-4 <?php echo $invalid_email;?>" value="<?php echo $_GET['email'];?>" placeholder="Email Address">
                    <?php echo $invalid_email_Msg;?>
                    <input name="phone" type="text" id="defaultRegisterPhonePassword" class="form-control m-0 p-4 <?php echo $invalid_phone;?>" value="<?php echo $_GET['phone'];?>" placeholder="Phone number" aria-describedby="defaultRegisterFormPhoneHelpBlock">
                    <?php echo $invalid_phone_Msg;?>

                    <!-- Password -->
                    <input name="password" type="password" id="defaultRegisterFormPassword" class="form-control m-0 p-4 <?php echo $invalid_password;?>" placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
                    <?php echo $invalid_password_Msg;?>
                    <input name="confirm_password" type="password" id="defaultRegisterFormPassword" class="form-control m-0 p-4 <?php echo $invalid_cpassword;?>" placeholder="Confirm Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
