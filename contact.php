...
if (isset($_GET['contact'])){
    ...
    $phone = $_GET['phone'];
    $msg = $_GET['message'];
    $contactMsg = $msg.' <br/> Contact '.$fullname.' :' .$phone;
...
<!--                        <iframe width="100%" height="350" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=usa&key=AIzaSyCCorS11q7oJIspTsTZ6OvMv59RWIjinwE" allowfullscreen></iframe>-->
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCorS11q7oJIspTsTZ6OvMv59RWIjinwE&callback=myMap"
