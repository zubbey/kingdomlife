                            ...
                            <div id="cart-form" class="col-sm-8">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="firstname" id="firstname" class="form-control <?php echo $invalid_field;?>" placeholder="First Name" value="<?php echo $_SESSION['fname']; ?>">
                                    </div>
                                    <div class="col">
                                        <label for="firstname">Last Name: </label>
                                        <?php echo $invalid_field_Msg;?>
                                        <input type="text" name="lastname" id="lastname" class="form-control <?php echo $invalid_field;?>" placeholder="Last Name" value="<?php echo $_SESSION['lname']; ?>">
                                    </div>
                                </div>
